  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const Text(rate, style: TextStyle(color: _textSecondary)),
        const SizedBox(height: 4),
        const Text('Platform Fee: \$1.20', style: TextStyle(color: _textSecondary)),
        const SizedBox(height: 16),
        ElevatedButton.icon(
      ...
      itemBuilder: (_, i) {
        return InkWell(
          ...
          child: Ink(
            ...
            child: Center(
              child: Text(keys[i], style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w600)),
            ),
          ),
        );
      },
